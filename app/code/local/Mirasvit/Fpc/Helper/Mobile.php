...
class Mirasvit_Fpc_Helper_Mobile extends Mage_Core_Helper_Abstract
{
    ...
    {
        $deviceType = false;
        $mobileDetect = Mage::getSingleton('fpc/config')->getMobileDetect();
        ...
        if ($mobileDetect) {
            ...
            // use the same cache for desktop and tablet
            if ($deviceType == 'tablet'
                && $mobileDetect != Mirasvit_Fpc_Model_Config::MOBILE_DETECT_MOBILE_TABLET) {
