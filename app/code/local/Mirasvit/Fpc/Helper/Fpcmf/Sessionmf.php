...
class Mirasvit_Fpc_Helper_Fpcmf_Sessionmf
{
    ...
    public function getCurrency()
    {
        ...
        if (isset($_COOKIE['currency'])
            && (!$currencyCode || $currencyCode != $_COOKIE['currency'])) {
    ...
    public function getStoreId()
    {
        ...
        if ($this->_requestHelper->isCrawler()) {
            ...
            //Add Store Code to Urls is enabled
            $config = new Mirasvit_Fpc_Model_Configmf();
            if ($config->isUseStoreEnabled()) {
                $storeId = $config->getUseStoreStoreId();
                if ($storeId) {
                    return $storeId;
                }
            }
    ...
    public function getCategory()
    {
        ...
        if ($uri) {
            ...
            $query = 'SELECT * FROM `' . $tableName . '` WHERE request_path = "' . $uri . '"';
