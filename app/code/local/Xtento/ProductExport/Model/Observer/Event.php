 ...
 * Last Modified: 2017-07-04T13:42:14+02:00
...
class Xtento_ProductExport_Model_Observer_Event extends Xtento_ProductExport_Model_Observer_Abstract
{
    ...
    const EVENT_CATALOG_PRODUCT_SAVE_COMMIT_AFTER = 3;
    ...
    public function getEvents($entity = false, $allEvents = false)
    {
        ...
        if ($allEvents || $entity == Xtento_ProductExport_Model_Export::ENTITY_PRODUCT) {
            ...
            $events[Xtento_ProductExport_Model_Export::ENTITY_PRODUCT][self::EVENT_CATALOG_PRODUCT_SAVE_COMMIT_AFTER] = array(
                'event' => 'catalog_product_save_commit_after',
                'label' => Mage::helper('xtento_productexport')->__('After product gets saved and committed to the database (Event: catalog_product_save_commit_after)'),
                'method' => 'getProduct()'
            );
        }
    ...
    public function catalog_product_save_commit_after(Varien_Event_Observer $observer)
    {
        $this->_handleEvent($observer, self::EVENT_CATALOG_PRODUCT_SAVE_COMMIT_AFTER, Xtento_ProductExport_Model_Export::ENTITY_PRODUCT);
    }
