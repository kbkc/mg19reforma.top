 ...
 */
class Istans_Nailgallery_Model_Resource_Gallery extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('istans_nailgallery/gallery', 'entity_id');
    }
    ...
    public function lookupStoreIds($galleryId)
    {
        ...
        $select  = $adapter->select()
            ->from($this->getTable('istans_nailgallery/gallery_store'), 'store_id')
     ...
     * @return Istans_Nailgallery_Model_Resource_Gallery
     * @author Ultimate Module Creator
     */
     ...
     * @param string $field
     * @param mixed $value
     * @param Istans_Nailgallery_Model_Gallery $object
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                array('nailgallery_gallery_store' => $this->getTable('istans_nailgallery/gallery_store')),
                $this->getMainTable() . '.entity_id = nailgallery_gallery_store.gallery_id',
                array()
            )
            ->where('nailgallery_gallery_store.store_id IN (?)', $storeIds)
            ->order('nailgallery_gallery_store.store_id DESC')
            ->limit(1);
        }
        return $select;
    }
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $table  = $this->getTable('istans_nailgallery/gallery_store');
    ...
    protected function _initCheckUrlKeySelect($urlKey, $store)
    {
        $select = $this->_getReadAdapter()->select()
            ...
            ->join(
                array('es' => $this->getTable('istans_nailgallery/gallery_store')),
