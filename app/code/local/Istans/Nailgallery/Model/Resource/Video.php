 ...
 */
class Istans_Nailgallery_Model_Resource_Video extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('istans_nailgallery/video', 'entity_id');
    }
    ...
    public function lookupStoreIds($videoId)
    {
        ...
        $select  = $adapter->select()
            ->from($this->getTable('istans_nailgallery/video_store'), 'store_id')
     ...
     * @return Istans_Nailgallery_Model_Resource_Video
     * @author Ultimate Module Creator
     */
     ...
     * @param string $field
     * @param mixed $value
     * @param Istans_Nailgallery_Model_Video $object
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                array('nailgallery_video_store' => $this->getTable('istans_nailgallery/video_store')),
                $this->getMainTable() . '.entity_id = nailgallery_video_store.video_id',
                array()
            )
            ->where('nailgallery_video_store.store_id IN (?)', $storeIds)
            ->order('nailgallery_video_store.store_id DESC')
            ->limit(1);
        }
        return $select;
    }
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $table  = $this->getTable('istans_nailgallery/video_store');
    ...
    protected function _initCheckUrlKeySelect($urlKey, $store)
    {
        $select = $this->_getReadAdapter()->select()
            ...
            ->join(
                array('es' => $this->getTable('istans_nailgallery/video_store')),
                'e.entity_id = es.video_id',
                array())
