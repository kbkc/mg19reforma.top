 ...
 */
/**
 * Video collection resource model
 *
 * @category    Istans
 * @package     Istans_Nailgallery
 * @author      Ultimate Module Creator
 */
class Istans_Nailgallery_Model_Resource_Video_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return Istans_Nailgallery_Model_Resource_Video_Collection
     * @author Ultimate Module Creator
     */
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('istans_nailgallery/video_store')),
