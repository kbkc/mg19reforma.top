 ...
 */
class Istans_Nailgallery_Model_Resource_Event extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('istans_nailgallery/event', 'entity_id');
    }
    ...
    public function lookupStoreIds($eventId)
    {
        ...
        $select  = $adapter->select()
            ->from($this->getTable('istans_nailgallery/event_store'), 'store_id')
     ...
     * @return Istans_Nailgallery_Model_Resource_Event
     * @author Ultimate Module Creator
     */
     ...
     * @param string $field
     * @param mixed $value
     * @param Istans_Nailgallery_Model_Event $object
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                array('nailgallery_event_store' => $this->getTable('istans_nailgallery/event_store')),
                $this->getMainTable() . '.entity_id = nailgallery_event_store.event_id',
                array()
            )
            ->where('nailgallery_event_store.store_id IN (?)', $storeIds)
            ->order('nailgallery_event_store.store_id DESC')
            ->limit(1);
        }
        return $select;
    }
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $table  = $this->getTable('istans_nailgallery/event_store');
    ...
    protected function _initCheckUrlKeySelect($urlKey, $store)
    {
        $select = $this->_getReadAdapter()->select()
            ...
            ->join(
                array('es' => $this->getTable('istans_nailgallery/event_store')),
