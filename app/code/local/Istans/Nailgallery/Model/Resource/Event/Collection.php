 ...
 */
class Istans_Nailgallery_Model_Resource_Event_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return Istans_Nailgallery_Model_Resource_Event_Collection
     * @author Ultimate Module Creator
     */
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('istans_nailgallery/event_store')),
                'main_table.entity_id = store_table.event_id',
                array()
            )
