 ...
 */
class Istans_Nailgallery_Model_Resource_Gallery_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return Istans_Nailgallery_Model_Resource_Gallery_Collection
     * @author Ultimate Module Creator
     */
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('istans_nailgallery/gallery_store')),
