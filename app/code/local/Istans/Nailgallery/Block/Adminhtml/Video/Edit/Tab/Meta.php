 ...
 */
class Istans_Nailgallery_Block_Adminhtml_Video_Edit_Tab_Meta extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return Istans_Nailgallery_Block_Adminhtml_Video_Edit_Tab_Meta
     * @author Ultimate Module Creator
     */
