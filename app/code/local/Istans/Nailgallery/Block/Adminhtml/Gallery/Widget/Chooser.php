...
class Istans_Nailgallery_Block_Adminhtml_Gallery_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl(
            '*/nailgallery_gallery_widget/chooser',
        ...
        $chooser = $this->getLayout()->createBlock('widget/adminhtml_widget_chooser')
            ...
            ->setUniqId($uniqId);
        if ($element->getValue()) {
            $gallery = Mage::getModel('istans_nailgallery/gallery')->load($element->getValue());
            if ($gallery->getId()) {
                $chooser->setLabel($gallery->getCaption());
            }
        }
     ...
     *
     * @access protected
     * @return Istans_Nailgallery_Block_Adminhtml_Gallery_Widget_Chooser
     * @author Ultimate Module Creator
     */
    ...
    {
        return $this->getUrl(
            'adminhtml/nailgallery_gallery_widget/chooser',
            array('_current' => true)
        );
    }
