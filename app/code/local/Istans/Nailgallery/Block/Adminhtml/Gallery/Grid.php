 ...
 */
class Istans_Nailgallery_Block_Adminhtml_Gallery_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Istans_Nailgallery_Block_Adminhtml_Gallery_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('istans_nailgallery/gallery')
            ->getCollection();
;
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'caption',
            array(
                'header'    => Mage::helper('istans_nailgallery')->__('Caption'),
                'align'     => 'left',
                'index'     => 'caption',
            )
        );
        ...
        $this->addColumn(
            'order',
            array(
                'header' => Mage::helper('istans_nailgallery')->__('Order'),
                'index'  => 'order',
            )
        );
     ...
     *
     * @access public
     * @param Istans_Nailgallery_Model_Gallery
     * @return string
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access protected
     * @param Istans_Nailgallery_Model_Resource_Gallery_Collection $collection
