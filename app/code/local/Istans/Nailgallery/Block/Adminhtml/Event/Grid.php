 ...
 */
class Istans_Nailgallery_Block_Adminhtml_Event_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Istans_Nailgallery_Block_Adminhtml_Event_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('istans_nailgallery/event')
            ->getCollection();
     ...
     *
     * @access public
     * @param Istans_Nailgallery_Model_Event
     * @return string
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access protected
     * @param Istans_Nailgallery_Model_Resource_Event_Collection $collection
