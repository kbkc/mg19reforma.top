 ...
 */
class Istans_Nailgallery_Block_Adminhtml_Event_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return Istans_Nailgallery_Block_Adminhtml_Event_Edit_Tab_Stores
     * @author Ultimate Module Creator
     */
