...
class Valdecode_CookieLaw_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        return $this->__(Mage::getStoreConfig('cookielaw/content/custom_message'));
    }

    public function getCustomMoreInfo()
    {
        return $this->__(Mage::getStoreConfig('cookielaw/content/custom_more_info'));
    }

    public function getCustomAccept()
    {
        return $this->__(Mage::getStoreConfig('cookielaw/content/custom_accept'));
    }
}
