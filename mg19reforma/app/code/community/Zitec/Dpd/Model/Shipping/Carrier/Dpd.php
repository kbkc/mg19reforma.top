...
class Zitec_Dpd_Model_Shipping_Carrier_Dpd extends Zitec_Dpd_Model_Shipping_Carrier_Abstract implements Zitec_PackedShipment_Model_Carrier_Interface
{
    ...
    {
        return Mage::getSingleton('zitec_dpd/config_source_service')->getAvailableServices();
    }
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        foreach ($rate as $r) {
            ...
            $methodDescriptions = Mage::getSingleton('zitec_dpd/config_source_service')->getAvailableServices();
