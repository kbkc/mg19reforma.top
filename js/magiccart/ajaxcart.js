        ...
        *******************************/
            ...
            sendAjax : function(idProduct, param, magiccartEvent) {
                ...
                if(idProduct) {
                    ...
                    postData = this.addProductParam(postData, magiccartEvent);
                    if('' == postData)
                        return true;
                            ...
                            if (transport.responseText.isJSON()) {
                                ...
                                if (response.error) {
                                    ...
                                    if(response.add_to_cart === '1'){
                                        ...
                                        var button = jQuery('button.'+response.added_product_id);
                                        var buttonHref = "'"+window.location.origin + '/checkout/cart'+"'";
                                        button.parent().append('<div class="button btn-cart" title="'+response.button_text+'">\n' +
                                            '                                    <span class="fa fa-shopping-cart" onclick="showpopup()">'+response.button_text+'</span>\n' +
                                            '                                </div>');
                                        button.remove();
            ...
            addProductParam: function(postData, event) {
            ...
            showPopup : function(data,isadd,action){
                ...
                if (jQuery('body').hasClass('quickorder-index-index')) {
                    jQuery("#popup-quickorder").css("display", "none");
                }
                var popupStatus     = 0;
