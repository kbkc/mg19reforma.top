...
jQuery(document).ready(function($) {
	...
	(function(selector){
	    ...
	    if($navDesktop.hasClass('sticker')){
            var headerHeight = $('.header-container').height()-30;
            var stickerHeight = $('.header-content').height();
            ...
            $(window).scroll(function () {
			 ...
			 if ($(this).scrollTop() > headerHeight) {
              ...
              //$('.header-top').addClass('margin-bottom');
             	$('.header-top').css('margin-bottom', stickerHeight+'px');
			 } 
			 else{
			  $('.header-sticker').removeClass('header-container-fixed');
			  //$('.header-top').removeClass('margin-bottom');
